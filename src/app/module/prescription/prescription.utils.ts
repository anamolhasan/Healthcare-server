...
export const generatePrescriptionPDF = async(prescriptionData:Prescription): Promise<Buffer> => {
            ...
            doc
              ...
              doc
                ...
                doc
                 ...
                 .text(`Issued Date: ${new Date(prescriptionData.createAt).toLocaleDateString()}`)
