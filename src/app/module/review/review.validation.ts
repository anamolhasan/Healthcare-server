...
const createReviewZodSchema = z.object({
    ...
    rating : z.number('Rating is required').min(1, 'Rating must beat least 1').max(5, 'Rating cannot be more than 5'),
...
const updateReviewZodSchema = z.object({
    ...
    comment : z.string('Comment is required').min(1, 'Cannot be empty').optional()
});
