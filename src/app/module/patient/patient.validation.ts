...
const updatePatientProfileZodSchema = z.object({
    ...
    medicalReports : z.array(z.object({
        ...
        message: 'Invalid medical report data. If shouldDelete is true, reportId must be provided. If reportId is provided, shouldDeleted must be true. If reportName is provided, reportLink must also be provided and vice versa. '
    })
})
