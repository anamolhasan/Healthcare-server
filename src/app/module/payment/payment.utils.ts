    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc
               ...
               .text(`Invoice Date: ${new Date(data.paymentDate).toLocaleDateString}`)
            ...
            // Doctor Information
            doc.fontSize(11).font('Helvetica').text('Doctor Information');
            doc
               .fontSize(10)
               .font('Helvetica')
            ...
            doc.fontSize(9).font('Helvetica').text(
                'Thank your for choosing PH Healthcare. This is an electronically generated invoice.', {
                    align:'center',
                }
            );
